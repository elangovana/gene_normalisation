...
class TestChemprotDataset(TestCase):
    ...
    def test__getitem__gene(self):
        ...
        """
        # Arrange
        input_raw = """10471277	Probing the salmeterol binding site on the beta 2-adrenergic receptor using a novel photoaffinity ligand
23150485	Induction of multidrug resistance transporter ABCG2"""
...
10471277	T40	GENE-Y	43	69	beta 2-adrenergic receptor"""
        ...
        expected = ["Probing the salmeterol binding site on the ", "beta 2-adrenergic receptor", " using a novel photoaffinity ligand"], ["O", "B-GENE", "O"]
...
10471277	T40	GENE-Y	43	69	beta 2-adrenergic receptor"""
            ...
            expected = ["Induction of multidrug resistance transporter ", "ABCG2"], ["O", "B-CHEMICAL"]
